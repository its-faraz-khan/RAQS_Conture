...
const Notification = () => {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      // Begin fade-out after 1.2 s
      hideTimer.current = setTimeout(() => setVisible(false), 1200);
      // Remove from DOM after fade-out animation (300 ms) completes
  ...
  return (
    <div
      className={`fixed top-[72px] md:top-[84px] left-0 right-0 flex justify-center z-[9999] pointer-events-none transition-opacity duration-300 ${
